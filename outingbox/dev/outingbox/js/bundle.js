...
(function(root, factory) {
	if (typeof define === 'function' && define.amd) {
		...
		module.exports = factory((typeof window !== "undefined" ? window['jQuery'] : typeof global !== "undefined" ? global['jQuery'] : null), require('sifter'), require('microplugin'));
	} else {
...
},{"microplugin":7,"sifter":11}],11:[function(require,module,exports){
/**
 * sifter.js
 * Copyright (c) 2013 Brian Reavis & contributors
 *
